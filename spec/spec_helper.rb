require 'simplecov'
SimpleCov.start
require_relative '../lib/url_request.rb'
...
require_relative '../lib/ssl_certificate.rb'
...
RSpec.configure do |config|
  config.before(:each) do
    stub_request(:get, /test.com/).to_return(status: 301, headers: { Location: "https://www.test.com/" })
    stub_request(:get, /testfail.com/).to_return(status: 200)
    ...
    stub_request(:get, '/www.testnositemap.com/robots.txt').to_return(status: 200, body: "no sitemap")
